...
namespace MedicalPLE.Areas.Admin.Controllers
{
    ...
    public class ArticulosController : Controller
    {
        ...
        public IActionResult Create(ArticuloVM artiVM)
        {
            if (ModelState.IsValid)
            {
                ...
                if (artiVM.Articulo.Id == 0)
                {
                    ...
                    CrearImagenArticulo(artiVM, rutaPrincipal, archivos);
        ...
        private static void CrearImagenArticulo(ArticuloVM artiVM, string rutaPrincipal, Microsoft.AspNetCore.Http.IFormFileCollection archivos)
        {
        ...
        public IActionResult Edit(ArticuloVM artiVM)
        {
            if (ModelState.IsValid)
            {
                ...
                if (archivos.Count() > 0)
                {
                    EditarImagenArticulo(artiVM, rutaPrincipal, archivos, articuloDesdeDb);
        ...
        private static void EditarImagenArticulo(ArticuloVM artiVM, string rutaPrincipal, Microsoft.AspNetCore.Http.IFormFileCollection archivos, Models.Articulo articuloDesdeDb)
        {
            string nombreArchivo = Guid.NewGuid().ToString();
            var subidas = Path.Combine(rutaPrincipal, @"imagenes\articulos");
            var extension = Path.GetExtension(archivos[0].FileName);
